        ...
        if(data.state == 0){
          ...
          if(linkManList.length > 0){
            ...
            for(var i = 0; i < linkManList.length; i++){
              ...
              var td5 = $("<td>"+linkMan.qq+"</td>");
              var td6 = $("<td>"+linkMan.trait+"</td>");
              var td7 = $("<td>"+linkMan.interviewCount+"</td>");
              var td8 = $("<td>"+linkMan.remark+"</td>");
              var td9;
              if(linkMan.interviewCount > 0){
                td9 = $("<td></td>")
              }else{
                td9 = $("<td><a href='#' style='color: #0092DC' onclick='del("+linkMan.id+")'>删除</a></td>")
              }
              tr.append(td).append(td2).append(td3).append(td4).append(td5).append(td6).append(td7).append(td8).append(td9);
              table.append(tr);
            }
          }
        }else{
