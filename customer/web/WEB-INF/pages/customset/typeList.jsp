...
<script>
  function add(){
    openDialog('添加客户类型', 0.3, 0.3, '${pageContext.request.contextPath}/addCustomerType/open.htm');
  }
  ...
  function edit(){
    ...
    openDialog('编辑客户类型', 0.3, 0.3, '${pageContext.request.contextPath}/editCustomerType/open.htm?id='+id);
  }
