...
<div id="divAdd">
  <header>
    <div class="header w">
      <p class="tit" style="text-align:center;">新增客户</p>
          ...
          <ul>
            <li>
              <div class="content">
                ...
                <div class="col-txt"><input type="text" class="input-txt" name="no" placeholder="请输入学校No"></div>
              </div>
            </li>
            <li>
              <div class="content">
                <div class="col-tg">学校名称：</div>
                <div class="col-txt"><input type="text" class="input-txt" id="name" name="name" placeholder="请输入学校名称（必填）"></div>
              </div>
            </li>
            <li>
              <div class="content">
                <div class="col-tg">客户代码：</div>
                <div class="col-txt"><input type="text" class="input-txt" name="code" placeholder="请输入客户代码"></div>
              </div>
            </li>
            <li>
              <div class="content">
                <div class="col-tg">办学规模：</div>
                <div class="col-txt"><input type="text" class="input-txt" id="scale" name="scale" placeholder="请输入办学规模（必填）"></div>
              </div>
            </li>
            <li>
              <div class="content">
                ...
                <div class="col-txt"><a href="javascript:;" id="areaText" onclick="selectIf(0)">请选择（必填） <i class="i-arr f-r"></i></a></div>
              </div>
            </li>
            <li>
              <div class="content">
                <div class="col-tg">详细地址：</div>
                <div class="col-txt"><textarea class="input-addr" id="address" name="address" placeholder="请输入详细地址（必填）"></textarea></div>
              </div>
            </li>
            <li>
              <div class="content">
                ...
                <div class="col-txt"><a href="javascript:;" id="typeText" onclick="selectIf(1)">请选择（必填） <i class="i-arr f-r"></i></a></div>
              </div>
            </li>
            <li>
              <div class="content">
                <input type="hidden" id="customerStateId" name="customerStateId">
                <div class="col-tg">客户状态：</div>
                <div class="col-txt"><a href="javascript:;" id="stateText" onclick="selectIf(2)">请选择（必填） <i class="i-arr f-r"></i></a></div>
              </div>
            </li>
          </ul>
